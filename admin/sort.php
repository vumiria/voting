...
<body>
    ...
    <div id="wrapper">
						...
						<button onclick="window.print();" style = "margin-right:14px; margin-bottom:12px;" id ="print" class = "pull-right btn btn-info"><i class = "fa fa-print"></i> Print</button>
                            <div class="table-responsive">
                              <table class="table table-striped table-bordered table-hover ">
                                <thead>
                      						<td style = "width:400px; background-color:#0b0097;color:white;"  class = "alert">Candidate for Representative</td>
		...
		while($fetch = $query->fetch_array())
		{
			...
			$query1 = $conn->query("SELECT COUNT(*) as total FROM `votes` WHERE candidate_id = '$id'  ORDER BY total  DESC");
