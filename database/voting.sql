...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 04, 2021 at 01:21 AM
...
(1, 'Class representative', 'k', 'del', 'Year 3', 'Male', 'upload/David.jpeg'),
(5, 'Class representative', 'M', 'JU', 'Year 3', 'Female', 'upload/David.jpeg');
...
(5, 1111, '', 'M', 'JU', 'Year 1', 'Unvoted', 'Active');
...
--
ALTER TABLE `votes`
  MODIFY `vote_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
COMMIT;
